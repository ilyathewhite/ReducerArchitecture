//
//  AsyncNavigationSwiftUIProxy.swift
//  ReducerArchitecture
//
...
@MainActor
public class AsyncNavigationPathContainer: ObservableObject, AsyncNavigationProxy {
